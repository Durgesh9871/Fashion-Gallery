  ...
  return (
    ...
    >
      <Flex
        ...
        align={"center"}
        background={(location.pathname == "/adminPage" || location.pathname == "/customerPageAdmin" || location.pathname == "/deltePageAdmin" || location.pathname == "/stat" || location.pathname == "/addPageAdmin"  || location.pathname == "/orderPageAdmin") ? "#171923" : "#ffffff"}
      >
        <Flex
          flex={{ base: 1, md: "auto" }}
          ml={{ base: -2 }}
