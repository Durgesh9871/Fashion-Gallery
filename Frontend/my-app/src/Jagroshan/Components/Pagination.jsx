...
const handleNextPage = (data)=>{
 ...
 const nextPageDisable = Math.ceil(paginationData.length/9)
  ...
  return (
    <Box style={{display:"flex" , justifyContent:"center"}}  padding="60px 0px" >

    <Button onClick={()=>handlePreviosPage(-1)} isLoading={pagePre} isDisabled={page==1}   ml="3"  pl={{base:"5px", sm: "10px", md: "10px", lg: "10px",xl: "10px",'2xl': "10px"}} pr={{base:"10px", sm: "10px", md: "10px", lg: "10px",xl: "10px",'2xl': "10px"}} > 
   <Text fontSize="22px" fontWeight="400"><ChevronLeftIcon fontSize="26px" ml="-8px" p="0"/>Prev</Text></Button>
    ...
    <Button onClick={()=>handleNextPage(1)} isLoading={pageNext} isDisabled={page == nextPageDisable}  ml="3" pl={{base:"10px", sm: "10px", md: "10px", lg: "10px",xl: "10px",'2xl': "10px"}} pr={{base:"5px", sm: "2px", md: "2px", lg: "2px",xl: "2px",'2xl': "2px"}}  > 
